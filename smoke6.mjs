...
const unlocked = await page.evaluate(() => window.__game ? ['cimes','littoral','traversee','couronne','midi'].filter(id => window.__career.isTourUnlocked(id)).length : 0);
console.log('  tours débloqués   :', unlocked, '/ 5');
